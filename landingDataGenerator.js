...
const generateLandingData = () => {
  return {
    ...
    descriptionText: [
      ...
      "In his wildly popular Internet blog, Timothy doesn’t sugarcoat or equivocate.",
      ...
      'Human beings are flawed and limited—"not everybody can be extraordinary, there are winners and losers in society, and some of it is not fair or your fault." Timothy advises us to get to know our limitations and accept them.',
      ...
      [
        ...
        "Best Book!",
        "Get Best Book Now!",
        "Get Your Best Copy Now!",
        "Get Best Book Now!",
        "Get Your Best Book Now!",
        "Buy Your Best Book Now!",
        "Buy Free Now!",
        "Get Your Guide!",
        "Get Your Guide Now!",
        "Buy Self-Development Book Now!",
        "Get Your Copy of Motivational Book Now!",
        "Get Self-Development Book Now! Buy Guide for Your Success!",
        "Get Your Self-Development Book Now!",
        "Buy Your Self-Development Book Now!",
        "Get Free Shipping Now! Buy Success Guide Book Online!",
        "Get Book on How to Get Rich Online Now!",
        "Get Our Self-Development Book Now!",
        "Best Self-Development Book! Buy Now!",
        "Get Best Self-Development Book Now!",
        "Get Your Best Self-Development Book Copy Now!",
        "Get Your Best Self-Development Book Now!",
        "Buy Your Best Self-Development Book Now!",
