...
;(function () {
    ...
    var a = String.fromCharCode,
      ...
      f = {
        ...
        decompressFromUint8Array: function (b) {
          ...
          for (var c = new Array(b.length / 2), d = 0, e = c.length; d < e; d++)
        ...
        _compress: function (a, b, c) {
            ...
            if (
              ...
              if (Object.prototype.hasOwnProperty.call(g, j)) {
                if (j.charCodeAt(0) < 256) {
                  for (d = 0; d < m; d++)
                    (o <<= 1),
                      p == b - 1 ? ((p = 0), n.push(c(o)), (o = 0)) : p++
                  for (e = j.charCodeAt(0), d = 0; d < 8; d++)
                    (o = (o << 1) | (1 & e)),
                      p == b - 1 ? ((p = 0), n.push(c(o)), (o = 0)) : p++,
                      (e >>= 1)
                } else {
                  for (e = 1, d = 0; d < m; d++)
                    (o = (o << 1) | e),
                      p == b - 1 ? ((p = 0), n.push(c(o)), (o = 0)) : p++,
                      (e = 0)
                  for (e = j.charCodeAt(0), d = 0; d < 16; d++)
                    (o = (o << 1) | (1 & e)),
                      p == b - 1 ? ((p = 0), n.push(c(o)), (o = 0)) : p++,
                      (e >>= 1)
                }
          ...
          if ('' !== j) {
            if (Object.prototype.hasOwnProperty.call(g, j)) {
              if (j.charCodeAt(0) < 256) {
                for (d = 0; d < m; d++)
                  (o <<= 1), p == b - 1 ? ((p = 0), n.push(c(o)), (o = 0)) : p++
                for (e = j.charCodeAt(0), d = 0; d < 8; d++)
                  (o = (o << 1) | (1 & e)),
                    p == b - 1 ? ((p = 0), n.push(c(o)), (o = 0)) : p++,
                    (e >>= 1)
        ...
        _decompress: function (b, c, d) {
          ...
          for (n = 0, p = Math.pow(2, 2), q = 1; q != p; )
            (o = s.val & s.position),
              (s.position >>= 1),
              0 == s.position && ((s.position = c), (s.val = d(s.index++))),
              (n |= (o > 0 ? 1 : 0) * q),
              (q <<= 1)
          switch ((f = n)) {
            case 0:
              for (n = 0, p = Math.pow(2, 8), q = 1; q != p; )
                (o = s.val & s.position),
                  (s.position >>= 1),
                  0 == s.position && ((s.position = c), (s.val = d(s.index++))),
                  (n |= (o > 0 ? 1 : 0) * q),
              ...
              break
            case 1:
              for (n = 0, p = Math.pow(2, 16), q = 1; q != p; )
                (o = s.val & s.position),
                  (s.position >>= 1),
                  0 == s.position && ((s.position = c), (s.val = d(s.index++))),
                  (n |= (o > 0 ? 1 : 0) * q),
  ...
  var untip = function (a) {
    return (a = LZString.decompressFromEncodedURIComponent(a))
  }
